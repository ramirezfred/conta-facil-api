...
///////////////////////////////////////////////////////////////////////////////
function imprime_factura_modulo($xml_archivo,$titulo,$tipo_factura,$logo,$nota_impresa,$color_marco,$color_marco_texto,$color_texto,$fuente_texto)
{
...
{
    libreria_mash('num2letras_modulo');
    
}
else
{

    include_once 'num2letras_modulo.php';
}
    ...
    $numeroletras=num2letras_modulo($total,'  ');    
