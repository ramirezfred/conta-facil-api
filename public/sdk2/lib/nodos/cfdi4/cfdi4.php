<?php
function mf_init_nodo_cfdi4(array &$datos = array())
{
    // Globales a usar
    global $__mf_constantes__;
    global $__mf_namespaces__;
	// Se indican los namespaces para CFDi 4.0
    $__mf_namespaces__['cfdi']['uri'] = 'http://www.sat.gob.mx/cfd/4';
    if($__mf_constantes__['__MF_VERSION_CFDI__'] == '4.0')
    {
        $__mf_namespaces__['cfdi']['xsd'] = 'http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd';
    }
    else
    {
        $__mf_namespaces__['cfdi']['xsd'] = 'http://www.sat.gob.mx/sitio_internet/cfd/4/cfdv40.xsd';
...
function mf_nodo_cfdi4(array &$datos)
{
    global $__mf_constantes__;
/////////// MASH INICIA 2020-04-07
	...
	else
	{
		...
		switch ($__mf_constantes__['__MF_VERSION_CFDI__'])
		{
			...
			case '4.0':
			{
                ...
                // InformacionGlobal
				$informacionglobal = '';
				if(isset($datos['InformacionGlobal']))
				{
					$informacionglobal .= mf_carga_nodo('informacionglobal', $datos['InformacionGlobal']);
				}
                // CfdisRelacionados
				$cfdisrelacionados = '';
                ...
                $comprobante = "<cfdi:Comprobante $atr>$informacionglobal$cfdisrelacionados$emisor$receptor$conceptos$impuestos$complemento_xml</cfdi:Comprobante>";
...
///aki $tmpok  no entra
    ...
    else
    {
        ...
        else
        {
            ...
            $xsdfile = $__mf_constantes__['__MF_XSD_DIR__'] . 'cfdv40.xsd';
            ...
            else
            {
                ...
                // Se timbra el XML
                $res = mf_timbrar_cfdi4(rand(1, 10), $datos['PAC']['usuario'], $datos['PAC']['pass'], '', $datos['url']);
