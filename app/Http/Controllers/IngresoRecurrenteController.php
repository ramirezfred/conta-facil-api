...
class IngresoRecurrenteController extends Controller
{
    public function index($user_id)
    {
        $coleccion = IngresoRecurrente::
    ...
    public function store(Request $request, $ingreso_id)
    {
        ...
        if($newObj=IngresoRecurrente::create([
    ...
    public function updateStatus(Request $request, $id)
    {
        ...
        $registro=IngresoRecurrente::find($id);
