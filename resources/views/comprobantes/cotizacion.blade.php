        ...
        <div class="content">
          ...
          <div style="padding: 15px; font-size: 14px;height: 25px;">
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>Cliente:</strong> {{ $data->opportunity->contacto->Nombre }}
                </td>
                <td style="width: 30%;">
                  <strong>Cotización {{ $data->folio }}</strong>
                </td>
              </tr>
            </table>
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>RFC:</strong> {{ $data->opportunity->contacto->Rfc }}
                </td>
                <td style="width: 30%;">
                  <strong>Fecha:</strong> {{ \Carbon\Carbon::parse($data->fecha_emision)->format('d-m-Y') }}
                </td>
              </tr>
            </table>
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>Email:</strong> {{ optional(optional($data->opportunity)->contacto)->Email ?? '-' }}
                </td>
              </tr>
            </table>
            ...
            <table class="table table-sm" style="width: 100%; font-size: 14px; margin-top: 50px;">
              ...
              <tbody>
                ...
                <tr style="height: 25px; font-size: 15px">
                  ...
                  <td style="text-align: right; margin-right: 8px;"><strong>$ {{$data->subtotal}}</strong></td>
                </tr>
                <tr style="height: 25px; font-size: 15px">
                  <td colspan="5" style="text-align: right;"><strong>Descuento</strong></td>
                  <td style="text-align: right; margin-right: 8px;"><strong>$ {{$data->descuento}}</strong></td>
                </tr>
                <tr style="height: 25px; font-size: 15px">
                  <td colspan="5" style="text-align: right;"><strong>Impuesto</strong></td>
                  <td style="text-align: right; margin-right: 8px;"><strong>$ {{$data->impuesto}}</strong></td>
                </tr>        
                <tr style="height: 25px; font-size: 15px">
                  <td colspan="5" style="text-align: right;"><strong>Total</strong></td>
                  <td style="text-align: right; margin-right: 8px;"><strong>$ {{$data->total}}</strong></td>
                </tr>
              </tbody>
            </table>
            ...
            <table width="100%">
              <tr>
                <td style="width: 100%;">
                  <strong>Observaciones:</strong> {{ $data->notas }}
                </td>
              </tr>
            </table>
            @endif
