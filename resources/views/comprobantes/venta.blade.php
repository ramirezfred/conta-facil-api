        ...
        <div class="content">
          ...
          <div style="padding: 15px; font-size: 14px;height: 25px;">
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>Cliente:</strong> {{ $data->contacto->Nombre }}
                </td>
                <td style="width: 30%;">
                  <strong>Orden {{ $data->folio }}</strong>
                </td>
              </tr>
            </table>
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>RFC:</strong> {{ $data->contacto->Rfc }}
                </td>
                <td style="width: 30%;">
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>Email:</strong> {{ optional($data->contacto)->Email ?? '-' }}
                </td>
              </tr>
            </table>
