        ...
        <div class="content">
          ...
          <div style="padding: 15px; font-size: 14px;height: 25px;">
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>Reporte:</strong> Estado de cuenta
                </td>
                <td style="width: 30%;">
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>Usuario:</strong> {{$user_nombre}}
                </td>
                <td style="width: 30%;">
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>Razón social:</strong> {{$cfdi_RazonSocial}}
                </td>
                <td style="width: 30%;">
                  <strong>RFC:</strong> {{$cfdi_Rfc}}
                </td>
              </tr>
            </table>
            ...
            <table width="100%">
              <tr>
                <td style="width: 70%;">
                  <strong>Código postal:</strong> {{$cfdi_CP}}
                </td>
                <td style="width: 30%;">
                </td>
              </tr>
              ...
              <tbody>
                {{-- @foreach ($cotizacion->gastos as $item) --}}
                    ...
                    <tr style="height: 25px;">
                      ...
                      <td style="text-align: right; margin-right: 8px;">
                        $ {{$total_ingresos_contables}}
                      </td>
                    </tr>
                    <tr style="height: 25px;">
                      <td>
                        Ingesos no Contables
                      </td>
                      <td style="text-align: right; margin-right: 8px;">
                        $ {{$total_ingresos_no_contables}}
                      </td>
                    </tr>
                {{-- @endforeach --}}
                <tr>
                ...
                <tr style="height: 25px; font-size: 15px">
                    ...
                    <td style="text-align: right; margin-right: 8px;">$ {{$total_general}}</td>
                </tr>
              </tbody>
            </table>
